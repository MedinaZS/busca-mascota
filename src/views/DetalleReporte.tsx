...
const DetalleReporte = () => {
    ...
    return (
        <PageCard title={'Detalle Reporte '}>
            <div className="reportcont">
                <p> Reporte #{report_id},{" "}creado con éxito!
                    El ID de su reporte es: {report_id},{" "}, guarde este identificador para futuras modificaciones o consultas.</p>
                ...
                <p className="my-3">La información propForcionada fue publicada en este sitio web, puede ver el reporte completo <Link to={`/report/${report_id}`}>aqui</Link>, también fue publicada en las distintas redes sociales de la página.</p>

                <Map zoom={15} click={false} />
